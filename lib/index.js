...
const mapGoldenNodeCiteID = (node, mapFunction) => tslib.__awaiter(void 0, void 0, void 0, function* () {
...
const mapGoldenSlateCiteIDs = (nodes, mapFunction) => tslib.__awaiter(void 0, void 0, void 0, function* () {
    return yield Promise.all(nodes.map((node) => tslib.__awaiter(void 0, void 0, void 0, function* () { return yield mapGoldenNodeCiteID(node, mapFunction); })));
});
...
const buildLink = ({ children, url }, deco, overrides) => {
    var _a, _b;
    const node = {
        type: "link",
        children: convertNodes(children, deco, overrides),
    ...
    if ((_a = match === null || match === void 0 ? void 0 : match.groups) === null || _a === void 0 ? void 0 : _a["id"]) {
        node.type = "cite";
        node.id = Number.parseInt((_b = match === null || match === void 0 ? void 0 : match.groups) === null || _b === void 0 ? void 0 : _b["id"]);
        node.children = [{ text: "" }];
    }
    else {
        node.url = url;
...
const childToGolden = (node) => {
    const { type, children } = node, data = tslib.__rest(node, ["type", "children"]);
    const newNode = {
        object: BLOCK_TYPES.includes(type) ? "block" : "inline",
        type,
        nodes: children === null || children === void 0 ? void 0 : children.reduce((arr, child) => {
            if ("children" in child) {
                arr.push(childToGolden(child));
            }
            else {
                const lastNode = arr[arr.length - 1];
                const _a = child, { text } = _a, marks = tslib.__rest(_a, ["text"]);
                const leaves = [
                    {
                        object: "leaf",
                        text,
...
exports.mapGoldenSlateCiteIDs = mapGoldenSlateCiteIDs;
exports.mdastToSlate = mdastToSlate;
exports.remarkToGoldenSlate = plugin;
exports.remarkToSlate = plugin$4;
exports.remarkToSlateLegacy = plugin$1;
exports.slateToMdast = slateToMdast;
exports.slateToRemark = plugin$3;
